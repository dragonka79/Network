...
# Note: This version does not include saving running-config to startup-config and no rollback!
...
def needs_change(config_xml):
    ...
    if ip_current != ip_address or mask_current != subnet_mask:
        return True
    return False
